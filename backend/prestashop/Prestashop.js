...
var _user$project$Prestashop$init = {
	ctor: '_Tuple2',
	_0: '',
	_1: {ctor: '[]'}
};
var _user$project$Prestashop$jd1 = _elm_lang$core$Json_Decode$int;
var _user$project$Prestashop$je1 = _elm_lang$core$Json_Encode$int(2);
var _user$project$Prestashop$Finish = {ctor: 'Finish'};
var _user$project$Prestashop$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Start') {
			return A2(
				...
				A2(
					...
					model,
					{
						...
						_0: A2(
							_elm_lang$core$Task$perform,
							function (_p1) {
								return _user$project$Prestashop$Finish;
							},
							A2(
								_elm_lang$core$Task$andThen,
								function (_p2) {
...
var _user$project$Prestashop$Start = {ctor: 'Start'};
var _user$project$Prestashop$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Ports$start(
				function (_p3) {
					return _user$project$Prestashop$Start;
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$Prestashop$main = _elm_lang$core$Platform$program(
	{
		init: _NoRedInk$rocket_update$Rocket$batchInit(_user$project$Prestashop$init),
		update: function (_p4) {
			return _NoRedInk$rocket_update$Rocket$batchUpdate(
				_user$project$Prestashop$update(_p4));
		},
		subscriptions: _user$project$Prestashop$subscriptions
	})();

var Elm = {};
Elm['Prestashop'] = Elm['Prestashop'] || {};
if (typeof _user$project$Prestashop$main !== 'undefined') {
    _user$project$Prestashop$main(Elm['Prestashop'], 'Prestashop', undefined);
}
