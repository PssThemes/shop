...
var _user$project$TestElm$init = {
	ctor: '_Tuple2',
	_0: '',
	_1: {ctor: '[]'}
};
...
var _user$project$TestElm$start = _elm_lang$core$Native_Platform.incomingPort(
	...
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));
var _user$project$TestElm$finish = _elm_lang$core$Native_Platform.outgoingPort(
	'finish',
	function (v) {
		return null;
	});
...
var Elm = {};
Elm['TestElm'] = Elm['TestElm'] || {};
if (typeof _user$project$TestElm$main !== 'undefined') {
    _user$project$TestElm$main(Elm['TestElm'], 'TestElm', undefined);
}
